  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <BluesShuffleEtudesStyled>
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-1.jpg`} width={600} height={487} alt="Blues shuffle etude 1" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-2.jpg`} width={600} height={487} alt="Blues shuffle etude 2" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-3.jpg`} width={600} height={490} alt="Blues shuffle etude 3" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-4.jpg`} width={600} height={555} alt="Blues shuffle etude 4" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-5.jpg`} width={600} height={560} alt="Blues shuffle etude 5" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-6.jpg`} width={600} height={550} alt="Blues shuffle etude 6" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-7.jpg`} width={600} height={539} alt="Blues shuffle etude 7" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-8.jpg`} width={600} height={562} alt="Blues shuffle etude 8" />

        <h2>Blues shuffle etude nine</h2>
        <p>All three patterns combined in the key of A. Practice slowly with smooth transitions between chords.</p>
        <Image src={`${course.imgPath}/blues-shuffle-etude-9.jpg`} width={600} height={555} alt="Blues shuffle etude 9" />
        ...
        <Image src={`${course.imgPath}/blues-shuffle-etude-10.jpg`} width={600} height={589} alt="Blues shuffle etude 10" />
      </BluesShuffleEtudesStyled>
    </CourseContainer>
  );
};
