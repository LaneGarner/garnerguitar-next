  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <CagedChordTonesStyled>
        ...
        <Image src={`${course.imgPath}/c-shape-chord-tones.jpg`} width={600} height={200} alt="C shape chord tones" />
        ...
        <Image src={`${course.imgPath}/a-shape-chord-tones.jpg`} width={600} height={200} alt="A shape chord tones" />
        ...
        <Image src={`${course.imgPath}/g-shape-chord-tones.jpg`} width={600} height={200} alt="G shape chord tones" />
        ...
        <Image src={`${course.imgPath}/e-shape-chord-tones.jpg`} width={600} height={200} alt="E shape chord tones" />
        ...
        <Image src={`${course.imgPath}/d-shape-chord-tones.jpg`} width={600} height={200} alt="D shape chord tones" />
        ...
        <h2>C minor</h2>
        <h3>R:C b3:Eb 5:G</h3>
        <Image src={`${course.imgPath}/c-minor-shape-chord-tones.jpg`} width={600} height={200} alt="C minor shape chord tones" />

        <h2>A minor</h2>
        <h3>R:A b3:C 5:E</h3>
        <Image src={`${course.imgPath}/a-minor-shape-chord-tones.jpg`} width={600} height={200} alt="A minor shape chord tones" />

        <h2>G minor</h2>
        <h3>R:G b3:Bb 5:D</h3>
        <Image src={`${course.imgPath}/g-minor-shape-chord-tones.jpg`} width={600} height={200} alt="G minor shape chord tones" />

        <h2>E minor</h2>
        <h3>R:E b3:G 5:B</h3>
        <Image src={`${course.imgPath}/e-minor-shape-chord-tones.jpg`} width={600} height={200} alt="E minor shape chord tones" />

        <h2>D minor</h2>
        <h3>R:D b3:F 5:A</h3>
        <Image src={`${course.imgPath}/d-minor-shape-chord-tones.jpg`} width={600} height={200} alt="D minor shape chord tones" />
      </CagedChordTonesStyled>
    </CourseContainer>
  );
};
