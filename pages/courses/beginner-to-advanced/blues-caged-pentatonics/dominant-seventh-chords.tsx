  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <DominantSeventhChordsStyled>
        ...
        <Image src={`${course.imgPath}/a-maj-scale-degrees.jpg`} width={600} height={100} alt="A major scale degrees" />
        ...
        <Image src={`${course.imgPath}/a-7-chord-spelling.jpg`} width={600} height={100} alt="A7 chord spelling" />
        ...
        <Image src={`${course.imgPath}/seventh-chord-voicings.jpg`} width={600} height={300} alt="Seventh chord voicings for blues" />
      </DominantSeventhChordsStyled>
    </CourseContainer>
  );
};
