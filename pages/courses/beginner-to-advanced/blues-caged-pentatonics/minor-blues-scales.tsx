  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <MinorBluesScalesStyled>
        ...
        <Image src={`${course.imgPath}/a-minor-blues.jpg`} width={600} height={200} alt="A minor blues scale" />
        <Image src={`${course.imgPath}/a-minor-blues-notation.jpg`} width={600} height={150} alt="A minor blues scale notation" />
        ...
        <Image src={`${course.imgPath}/e-minor-blues.jpg`} width={600} height={200} alt="E minor blues scale" />
        <Image src={`${course.imgPath}/e-minor-blues-notation.jpg`} width={600} height={150} alt="E minor blues scale notation" />
      </MinorBluesScalesStyled>
    </CourseContainer>
  );
};
