  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <MinorPentatonicPositionsStyled>
        ...
        <Image src={`${course.imgPath}/a-minor-pent-spelling-1.jpg`} width={600} height={150} alt="A minor pentatonic spelling" />
        ...
        <Image src={`${course.imgPath}/a-minor-pent-spelling-2.jpg`} width={600} height={150} alt="A minor pentatonic scale degrees" />
        ...
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-1.jpg`} width={600} height={200} alt="A minor pentatonic box 1" />
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-1-notation.jpg`} width={600} height={100} alt="A minor pentatonic box 1 notation" />
        ...
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-2.jpg`} width={600} height={200} alt="A minor pentatonic box 2" />
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-2-notation.jpg`} width={600} height={100} alt="A minor pentatonic box 2 notation" />
        ...
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-3.jpg`} width={600} height={200} alt="A minor pentatonic box 3" />
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-3-notation.jpg`} width={600} height={100} alt="A minor pentatonic box 3 notation" />
        ...
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-4.jpg`} width={600} height={200} alt="A minor pentatonic box 4" />
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-4-notation.jpg`} width={600} height={100} alt="A minor pentatonic box 4 notation" />
        ...
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-5.jpg`} width={600} height={200} alt="A minor pentatonic box 5" />
        <Image src={`${course.imgPath}/a-minor-pentatonic-box-5-notation.jpg`} width={600} height={100} alt="A minor pentatonic box 5 notation" />
      </MinorPentatonicPositionsStyled>
    </CourseContainer>
  );
};
