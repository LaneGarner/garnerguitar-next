  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <ListeningStyled>
        ...
        <Image src={`${course.imgPath}/chinese-music.jpg`} width={100} height={52} alt="Chinese symbol for music" />
        ...
        <Image src={`${course.imgPath}/f-hole-cutout.jpg`} width={400} height={276} alt="Guitar f-hole" />
      </ListeningStyled>
    </CourseContainer>
  );
};
