  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <NotationStyled>
        ...
        <h2>Tablature</h2>
        <Image src={`${course.imgPath}/tab-example.jpg`} width={500} height={150} alt="Tablature example" />
        ...
        <Image src={`${course.imgPath}/standard-notation-example.jpg`} width={500} height={150} alt="Standard notation example" />
        ...
        <Image src={`${course.imgPath}/chord-diagram-example-1.jpg`} width={150} height={180} alt="Simple chord diagram example" />
        ...
        <div className="diagram-examples">
          <Image src={`${course.imgPath}/chord-diagram-example-2.jpg`} width={400} height={200} alt="Chord diagram with open strings" />
          <Image src={`${course.imgPath}/chord-diagram-example-3.jpg`} width={400} height={200} alt="Chord diagram with muted strings" />
          <Image src={`${course.imgPath}/chord-diagram-example-4.jpg`} width={400} height={200} alt="Chord diagram at different position" />
        </div>
      </NotationStyled>
    </CourseContainer>
  );
