    ...
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <OpenChordsStyled>
        ...
        <div className="chord-charts">
          <Image src={`${course.imgPath}/open-chords-1.jpg`} width={700} height={300} alt="Open chords chart 1" />
          <Image src={`${course.imgPath}/open-chords-2.jpg`} width={700} height={300} alt="Open chords chart 2" />
          <Image src={`${course.imgPath}/open-chords-3.jpg`} width={700} height={300} alt="Open chords chart 3" />
          <Image src={`${course.imgPath}/open-chords-4.jpg`} width={700} height={300} alt="Open chords chart 4" />
          <Image src={`${course.imgPath}/open-chords-5.jpg`} width={700} height={300} alt="Open chords chart 5" />
          <Image src={`${course.imgPath}/open-chords-6.jpg`} width={700} height={300} alt="Open chords chart 6" />
          <Image src={`${course.imgPath}/open-chords-7.jpg`} width={700} height={300} alt="Open chords chart 7" />
        </div>
      </OpenChordsStyled>
    </CourseContainer>
  );
