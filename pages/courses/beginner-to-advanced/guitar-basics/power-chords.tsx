  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <PowerChordsStyled>
        ...
        <Image src={`${course.imgPath}/sixth-root-open-power-chords.jpg`} width={600} height={200} alt="Sixth string root open power chords" />
        <Image src={`${course.imgPath}/fifth-root-open-power-chords.jpg`} width={600} height={200} alt="Fifth string root open power chords" />
        ...
        <Image src={`${course.imgPath}/sixth-root-power-chords.jpg`} width={600} height={200} alt="Sixth string root fretted power chords" />
        <Image src={`${course.imgPath}/fifth-root-power-chords.jpg`} width={600} height={200} alt="Fifth string root fretted power chords" />

        <div className="hand-images">
          <Image src={`${course.imgPath}/power-chord-hand-1.jpg`} width={300} height={225} alt="Power chord hand position front view" />
          <Image src={`${course.imgPath}/power-chord-hand-2.jpg`} width={300} height={225} alt="Power chord hand position side view" />
        </div>
      </PowerChordsStyled>
    </CourseContainer>
  );
