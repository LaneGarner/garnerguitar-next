  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <TablatureStyled>
        ...
        <Image src={`${course.imgPath}/ag-fence.jpg`} width={400} height={300} alt="Acoustic guitar against fence" />
        ...
        <Image src={`${course.imgPath}/tab-strings.jpg`} width={500} height={150} alt="Tab strings diagram" />
        <Image src={`${course.imgPath}/tab-notes.jpg`} width={500} height={150} alt="Tab notes diagram" />
        ...
        <Image src={`${course.imgPath}/tab-etude-1.jpg`} width={600} height={120} alt="Tablature etude one" />
        ...
        <Image src={`${course.imgPath}/tab-etude-2.jpg`} width={600} height={120} alt="Tablature etude two" />
        ...
        <Image src={`${course.imgPath}/tab-etude-3.jpg`} width={600} height={120} alt="Tablature etude three - Mary Had a Little Lamb" />
