  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <FourthStringStyled>
        ...
        <Image src={`${course.imgPath}/fourth-string-notes.jpg`} width={600} height={200} alt="Fourth string notes" />

        <Image src={`${course.imgPath}/fourth-string-exercise-1.jpg`} width={600} height={150} alt="Fourth string exercise 1" />
        <Image src={`${course.imgPath}/fourth-string-exercise-2.jpg`} width={600} height={150} alt="Fourth string exercise 2" />
        <Image src={`${course.imgPath}/fourth-string-exercise-3.jpg`} width={600} height={150} alt="Fourth string exercise 3" />

        <h2>Frere Jacques</h2>
        <Image src={`${course.imgPath}/fourth-string-exercise-4.jpg`} width={600} height={200} alt="Frere Jacques notation" />

        <h2>Flats and repeats</h2>
        <Image src={`${course.imgPath}/flats-and-repeats.jpg`} width={600} height={150} alt="Flats and repeats" />
        ...
        <Image src={`${course.imgPath}/fourth-string-exercise-5.jpg`} width={600} height={200} alt="Deck the Halls notation" />
        ...
        <Image src={`${course.imgPath}/dreidel.jpg`} width={600} height={200} alt="The Dreidel Song notation" />

        <h2>O Christmas Tree</h2>
        <Image src={`${course.imgPath}/christmas-tree.jpg`} width={600} height={200} alt="O Christmas Tree notation" />

        <h2>Take Me Out to the Ballgame</h2>
        <Image src={`${course.imgPath}/ballgame.jpg`} width={600} height={250} alt="Take Me Out to the Ballgame notation" />
      </FourthStringStyled>
    </CourseContainer>
  );
};
