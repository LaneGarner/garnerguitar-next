  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <IntervalsStyled>
        ...
        <Image src={`${course.imgPath}/intervals.jpg`} width={600} height={300} alt="Intervals" />
        ...
        <Image src={`${course.imgPath}/interval-inversions.jpg`} width={600} height={200} alt="Interval inversions" />
        ...
        <Image src={`${course.imgPath}/rule-of-nine-1.jpg`} width={600} height={150} alt="Rule of nine" />
        <Image src={`${course.imgPath}/rule-of-nine-2.jpg`} width={600} height={150} alt="Rule of nine 2" />
        <Image src={`${course.imgPath}/jm-closeup.jpg`} width={500} height={350} alt="Jazzmaster closeup" />
      </IntervalsStyled>
    </CourseContainer>
  );
};
