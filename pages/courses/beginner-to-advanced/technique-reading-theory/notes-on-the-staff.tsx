  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <NotesOnStaffStyled>
        ...
        <Image src={`${course.imgPath}/notes-on-staff.jpg`} width={600} height={620} alt="Notes on the staff" />
        ...
        <Image src={`${course.imgPath}/line-notes.jpg`} width={600} height={620} alt="Line notes" />
        ...
        <Image src={`${course.imgPath}/space-notes.jpg`} width={600} height={130} alt="Space notes" />
        ...
        <Image src={`${course.imgPath}/ledger-lines.jpg`} width={600} height={154} alt="Ledger line notes" />
        ...
        <Image src={`${course.imgPath}/practice-identifying-notes.jpg`} width={600} height={64} alt="Practice identifying notes" />
        <Image src={`${course.imgPath}/practice-identifying-notes-2.jpg`} width={600} height={64} alt="Practice identifying notes 2" />

        <h2>Practice writing notes</h2>
        <p>Try writing the following notes:</p>
        <Image src={`${course.imgPath}/practice-writing-notes-2.jpg`} width={600} height={182} alt="Practice writing notes" />
      </NotesOnStaffStyled>
    </CourseContainer>
  );
};
