  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <PullOffsHammerOnsStyled>
        ...
        <Image src={`${course.imgPath}/pull-offs.jpg`} width={600} height={200} alt="Pull-offs exercise one" />
        ...
        <Image src={`${course.imgPath}/hammer-ons.jpg`} width={600} height={200} alt="Hammer-ons exercise" />
        ...
        <Image src={`${course.imgPath}/pull-offs-2.jpg`} width={600} height={200} alt="Pull-offs exercise two" />
        <Image src={`${course.imgPath}/hammer-ons-2.jpg`} width={600} height={200} alt="Hammer-ons exercise two" />
      </PullOffsHammerOnsStyled>
    </CourseContainer>
  );
};
