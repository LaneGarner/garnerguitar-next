  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <RhythmicHierarchyStyled>
        ...
        <Image src={`${course.imgPath}/rhythmic-heirarchy.jpg`} width={600} height={300} alt="The rhythmic hierarchy exercise" />
        ...
        <Image src={`${course.imgPath}/triplets.jpg`} width={600} height={150} alt="Triplets" />
        ...
        <Image src={`${course.imgPath}/rhythmic-heirarchy-triplets.jpg`} width={600} height={300} alt="The rhythmic hierarchy exercise with triplets" />
      </RhythmicHierarchyStyled>
    </CourseContainer>
  );
};
