  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <ScalesStyled>
        ...
        <Image src={`${course.imgPath}/c-major-open.jpg`} width={600} height={274} alt="C major scale open position" />

        <h2>Natural notes in the open position</h2>
        <Image src={`${course.imgPath}/natural-notes-open.jpg`} width={600} height={309} alt="Natural notes in open position" />
        ...
        <Image src={`${course.imgPath}/chromatic-scale-open.jpg`} width={600} height={727} alt="Chromatic scale in open position" />
      </ScalesStyled>
    </CourseContainer>
  );
};
