  ...
  return (
    <CourseContainer courseTypeIndex={courseTypeIndex} course={course} courseIndex={courseIndex} page={page}>
      <StandardNotationIntroStyled>
        <Image src={`${course.imgPath}/standard-notation-guitars.jpg`} width={600} height={561} alt="Strat and Jazzmaster close up" />


        <h2>Rhythm review</h2>
        <Image src={`${course.imgPath}/rhythm-review.jpg`} width={600} height={344} alt="Rhythm review" />
        ...
        <Image src={`${course.imgPath}/staff-example.jpg`} width={600} height={150} alt="Staff elements" />
        ...
        <Image src={`${course.imgPath}/time-signatures.jpg`} width={600} height={392} alt="Time signature examples" />
        ...
        <h3>Key signature</h3>
        <Image src={`${course.imgPath}/key-signature.jpg`} width={600} height={160} alt="Key signature examples" />
        ...
        <h3>Accidentals</h3>
        <Image src={`${course.imgPath}/accidentals.jpg`} width={600} height={139} alt="Accidental examples" />
        ...
        <Image src={`${course.imgPath}/metronome-mark.jpg`} width={300} height={275} alt="Metronome mark example" />
        ...
        <Image src={`${course.imgPath}/dynamics.jpg`} width={600} height={847} alt="Dynamics examples" />

        <h3>Double and final bar lines</h3>
        <Image src={`${course.imgPath}/double-final-barlines.jpg`} width={400} height={128} alt="Double and final bar line examples" />
        ...
        <Image src={`${course.imgPath}/repeats.jpg`} width={600} height={151} alt="Repeats example" />
        ...
        <Image src={`${course.imgPath}/roadmap-items.jpg`} width={600} height={94} alt="Musical roadmap items" />
        ...
        <Image src={`${course.imgPath}/roadmap.jpg`} width={600} height={570} alt="Following the musical roadmap" />
      </StandardNotationIntroStyled>
    </CourseContainer>
  );
};
